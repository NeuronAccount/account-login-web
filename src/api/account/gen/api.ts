...
export const DefaultApiFetchParamCreator = {
     ...
     * @param name 
     * @param password 
     * @param oauth2AuthorizeParams 
     */
    login(params: {  "name": string; "password": string; "oauth2AuthorizeParams"?: OAuth2AuthorizeParams; }, options?: any): FetchArgs {
        ...
        if (params["oauth2AuthorizeParams"]) {
            fetchOptions.body = JSON.stringify(params["oauth2AuthorizeParams"] || {});
        }
     ...
     * @param oauth2AuthorizeParams 
     */
    smsLogin(params: {  "phone": string; "smsCode": string; "oauth2AuthorizeParams"?: OAuth2AuthorizeParams; }, options?: any): FetchArgs {
        // verify required parameter "phone" is set
        if (params["phone"] == null) {
     ...
     * @param oauth2AuthorizeParams 
     */
    smsSignup(params: {  "phone": string; "smsCode": string; "password": string; "oauth2AuthorizeParams"?: OAuth2AuthorizeParams; }, options?: any): FetchArgs {
        // verify required parameter "phone" is set
        if (params["phone"] == null) {
...
export const DefaultApiFp = {
     ...
     * @param oauth2AuthorizeParams 
     */
    login(params: { "name": string; "password": string; "oauth2AuthorizeParams"?: OAuth2AuthorizeParams;  }, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<LoginResponse> {
     ...
     * @param oauth2AuthorizeParams 
     */
    smsLogin(params: { "phone": string; "smsCode": string; "oauth2AuthorizeParams"?: OAuth2AuthorizeParams;  }, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<LoginResponse> {
     ...
     * @param oauth2AuthorizeParams 
     */
    smsSignup(params: { "phone": string; "smsCode": string; "password": string; "oauth2AuthorizeParams"?: OAuth2AuthorizeParams;  }, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<LoginResponse> {
...
export class DefaultApi extends BaseAPI {
     ...
     * @param oauth2AuthorizeParams 
     */
    login(params: {  "name": string; "password": string; "oauth2AuthorizeParams"?: OAuth2AuthorizeParams; }, options?: any) {
     ...
     * @param oauth2AuthorizeParams 
     */
    smsLogin(params: {  "phone": string; "smsCode": string; "oauth2AuthorizeParams"?: OAuth2AuthorizeParams; }, options?: any) {
     ...
     * @param oauth2AuthorizeParams 
     */
    smsSignup(params: {  "phone": string; "smsCode": string; "password": string; "oauth2AuthorizeParams"?: OAuth2AuthorizeParams; }, options?: any) {
