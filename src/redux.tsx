...
import {DefaultApiFactory, LoginResponse, OAuth2AuthorizeParams} from "./api/account/gen/api";
...
function errorFromResponse(response:any):Promise<ApiError> {
...
export interface SmsSignupParams {
    ...
    smsCode: string,
    password: string,
    oauth2AuthorizeParams?: OAuth2AuthorizeParams
}
...
function loginResponse(state:LoginResponse,action:AnyAction) {
